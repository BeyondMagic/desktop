...
hl.animation({ leaf = "windows", enabled = true, speed = 8.0, bezier = "md3_decel", style = "popin 80%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 10, bezier = "menu_decel", style = "slide" })
